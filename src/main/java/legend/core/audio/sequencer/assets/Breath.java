...
public final class Breath {
   ...
   */
  private static final float[][] waveforms = new float[2][];
  ...
  static {
    ...
    addBreath(new int[] {
      ...
      waveforms[0], false, false, false, false);
    ...
    addBreath(new int[] {
      ...
      waveforms[1], true, false, false, false);
    ...
    addBreath(new int[] {
      ...
      waveforms[0], false, true, false, false);
    ...
    addBreath(new int[] {
      ...
      0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
      0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x00},
      waveforms[1], true, true, false, false);
    ...
    addBreath(new int[] {
      ...
      0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
      0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x00},
      waveforms[0], false, true, true, true);
    ...
    addBreath(new int[] {
      ...
      0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
      0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x00},
      waveforms[1], true, true, true, true);
    ...
    addBreath(new int[] {
      ...
      0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
      0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x00},
      waveforms[0], false, true, false, true);
    ...
    addBreath(new int[] {
      ...
      0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
      0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x00},
      waveforms[1], true, true, false, true);
  }
  ...
  private final boolean doubleFrequency;

  private Breath(final float[] curve, final boolean lerp, final boolean half, final boolean abs, final boolean doubleFrequency) {
    this.waveform = curve;
    this.lerp = lerp;
    this.half = half;
    this.abs = abs;
  ...
  public boolean isDoubleFrequency() {
    return this.doubleFrequency;
  }
  ...
  private static void addBreath(final int[] data, final float[] curve, final boolean lerpInterp, final boolean half, final boolean abs, final boolean doubleFrequency) {
    final int hash = hash(data);

    map.put(hash, new Breath(curve, lerpInterp, half, abs, doubleFrequency));
  }
